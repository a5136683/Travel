...
public class DestinationFragment extends android.support.v4.app.Fragment implements View.OnClickListener{
    ...
    @BindView(R.id.dl)DrawerLayout dl;
    @BindView(R.id.destination_show)ImageView destination_show;
    @BindView(destination_Hot)TextView hot;
    @BindView(R.id.destination_Asia)TextView asia;
    @BindView(R.id.destination_North)TextView north;
    @BindView(R.id.destination_South)TextView south;
    @BindView(R.id.destination_Europe)TextView europe;
    @BindView(R.id.destination_Africa)TextView africa;
    @BindView(R.id.destination_Oceania) TextView oceania;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setListener();
        dl.setScrimColor(Color.TRANSPARENT);//讲滑出时的布局设置为透明
        dl.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED);//关闭手势滑动
