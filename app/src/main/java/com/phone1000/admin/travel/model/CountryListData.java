...
public class CountryListData implements ICountryData {

    private Retrofit retrofit = null;
    private ICountryPresenter iCountryPresenter = null;

    public CountryListData(ICountryPresenter iCountryPresenter) {
