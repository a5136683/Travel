...
public class SevenFragmentAdapter extends BaseAdapter {
    private Context context = null;
    private List<SevenDataInfo.ResultBean> list = null;

    public SevenFragmentAdapter(Context context, List<SevenDataInfo.ResultBean> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view ==null){
            v = LayoutInflater.from(context).inflate(R.layout.seven_fragment_item,viewGroup,false);
